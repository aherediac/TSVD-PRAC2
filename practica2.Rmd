...
Com obtenim un valor superior al llinar de 0.05, podem considerar que les variables comparades són homogenies (Hem triat les referents a l'acidesa per tenir un conjunt del mateix context).
